...
#define STRING_CONFIG_H_AUTHOR "(a5huynh, Maker Select V2)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // src: https://github.com/chasetec/Marlin/blob/1.1.x/Marlin/example_configurations/Wanhao/Duplicator%20i3%20bltouch/Configuration.h
    // Wanhao Duplication i3
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -26, -46, -0.65 }
